 ...
 */
final class Version20240812151353 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__product AS SELECT id, name, slug, description, more_description, additional_infos, stock, sale_price, regular_price, image_urls, brand, is_available, is_best_seller, is_new_arrival, is_featured, is_special_offer, updated_at, created_at FROM product');
        $this->addSql('DROP TABLE product');
        $this->addSql('CREATE TABLE product (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, related_products_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, more_description CLOB DEFAULT NULL, additional_infos CLOB DEFAULT NULL, stock INTEGER DEFAULT NULL, sale_price INTEGER NOT NULL, regular_price INTEGER NOT NULL, image_urls CLOB NOT NULL --(DC2Type:array)
