 ...
 */
final class Version20240906161646 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "order" ADD COLUMN stripe_client_secret VARCHAR(255) DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__order AS SELECT id, client_name, billing_address, shipping_address, quantity, order_cost, taxe, order_cost_ttc, is_paid, status, carrier_price, carrier_name, carrier_id, updated_at, created_at FROM "order"');
